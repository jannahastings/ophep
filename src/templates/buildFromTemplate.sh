...
robot template --input imports.owl  --prefix "OPHEP: http://purl.obolibrary.org/obo/OPHEP_" --ontology-iri "http://purl.obolibrary.org/obo/OPHEP.owl" --template ophep.csv --output ophep-template.owl
